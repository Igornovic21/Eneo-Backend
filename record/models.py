...
class Record(models.Model):
    ...
    i1_input = models.CharField(max_length=100, default="", db_index=True)
    i1_output = models.CharField(max_length=100, default="", db_index=True)
    i2_input = models.CharField(max_length=100, default="", db_index=True)
    i2_output = models.CharField(max_length=100, default="", db_index=True)
    i3_input = models.CharField(max_length=100, default="", db_index=True)
    i3_output = models.CharField(max_length=100, default="", db_index=True)
    i4_input = models.CharField(max_length=100, default="", db_index=True)
    i4_output = models.CharField(max_length=100, default="", db_index=True)
